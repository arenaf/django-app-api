...
class PrivateRecipeAPITest(TestCase):
    ...
    def test_full_update(self):
        ...
        payload = {
            ...
            'description': 'Sample newrecipe description',
            'time_minutes': 10,
            'price': Decimal('2.50'),
        }
        url = detail_url(recipe.id)
    ...
    def test_update_recipe_assign_tag(self):
        """Test assigning an existing tag when updatin a recipe"""
    ...
    def test_create_recipe_with_existing_ingredients(self):
        ...
        payload = {
            ...
            'time_minutes': 45,
            'price': Decimal('2.50'),
            'ingredients': [{'name': 'Garlic'}, {'name': 'Lemon'}]
        }
        res = self.client.post(RECIPES_URL, payload, format='json')
    ...
    def test_update_recipe_assign_ingredient(self):
        ...
        payload = {'ingredients': [{'name': 'Coriander'}]}
        url = detail_url(recipe.id)
        res = self.client.patch(url, payload, format='json')
    ...
    def test_filter_by_tags(self):
        ...
        recipe2 = create_recipe(user=self.user, title="Hummus")
        tag1 = Tag.objects.create(user=self.user, name="Vegetaria")
    ...
    def test_filter_by_ingredients(self):
        recipe1 = create_recipe(user=self.user, title="Poke")
        recipe2 = create_recipe(user=self.user, title="Guacamole Toast")
        ingredient1 = Ingredient.objects.create(user=self.user, name="Lunch")
        ingredient2 = Ingredient.objects.create(user=self.user, name="Breakfast")
        recipe1.ingredients.add(ingredient1)
        recipe2.ingredients.add(ingredient2)
        recipe3 = create_recipe(user=self.user, title="Chickpeas")
...
class ImageUploadTests(TestCase):
    ...
    def tearDown(self): # Execute after the test
    ...
    def test_upload_image(self):
        ...
        with tempfile.NamedTemporaryFile(suffix='.jpg') as image_file:
            ...
            img.save(image_file, forma='JPEG')
            image_file.seek(0)
